...
| The barplots show the genomic distribution of Ascl1 binding sites with decreased (NFR->NOR) or increased (NOR->NFR) chromatin accessibility in MEF reprogramming. | Figure S9b | [R](https://colab.research.google.com/github/gongx030/seatac_manuscript/blob/main/Ascl1_MEF_Seatac_Supplementary_v1.ipynb) |
| The aggregated V-plot include 24,098 and 7,071 Ascl1 binding sites that have increased (NOR->NFR) or decreased (NFR->NOR) chromatin accessibility during MEF reprograming. | Figure S9c | [R](https://colab.research.google.com/github/gongx030/seatac_manuscript/blob/main/Ascl1_MEF_Seatac_Supplementary_v1.ipynb) |
